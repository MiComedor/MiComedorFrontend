...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React4.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React9.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
var MonthCalendarButton = React10.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendarButton = React12.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
//# sourceMappingURL=chunk-XQUETEQ6.js.map
