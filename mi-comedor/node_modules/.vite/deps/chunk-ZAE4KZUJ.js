...
var useChartDimensions = ({
  ...
  const isXInside = React.useCallback((x2) => x2 >= drawingArea.left - 1 && x2 <= drawingArea.left + drawingArea.width, [drawingArea.left, drawingArea.width]);
  const isYInside = React.useCallback((y2) => y2 >= drawingArea.top - 1 && y2 <= drawingArea.top + drawingArea.height, [drawingArea.height, drawingArea.top]);
  const isPointInside = React.useCallback((x2, y2, targetElement) => {
...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React3.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React3.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React3.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
...
var useChartAnimation = ({
  ...
  const disableAnimation = React4.useCallback(() => {
...
var useInteractionItemProps = (data, skip) => {
  ...
  const interactionActive = React31.useRef(false);
  ...
  const onPointerLeave = React31.useCallback(() => {
  ...
  return (0, import_jsx_runtime21.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime21.jsxs)(React38.Fragment, {
...
var ChartsSurface = React39.forwardRef(function ChartsSurface2(inProps, ref) {
  const store = useStore();
  const {
    width: svgWidth,
    height: svgHeight
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React40.useRef({});
  const delauneyRef = React40.useRef(void 0);
  const lastFind = React40.useRef(void 0);
...
var _excluded14 = ["children", "localeText", "plugins", "seriesConfig"];
...
use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZAE4KZUJ.js.map
