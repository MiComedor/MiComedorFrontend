...
} from "./chunk-CQJMDZX7.js";
import {
  FormControl_default,
  FormHelperText_default,
  InputLabel_default,
  TextField_default
} from "./chunk-BXEILEA5.js";
import {
  ClearIcon,
  DIALOG_WIDTH,
  PickerProvider,
  ...
  validateSections,
  validateTime
} from "./chunk-7ISBZZ2K.js";
import {
  visuallyHidden_default
} from "./chunk-U47Y2AWD.js";
import {
  Dialog_default,
  dialogClasses_default
} from "./chunk-FVE4KIBF.js";
import {
  Fade_default
} from "./chunk-KLMXXMDD.js";
import {
  DialogContent_default
} from "./chunk-IGQSBUPH.js";
import {
  useFormControl
} from "./chunk-EPZO6JO7.js";
import {
  useSlotProps_default
} from "./chunk-KR4O37UX.js";
import {
  IconButton_default
} from "./chunk-3EE7QGTU.js";
import {
  useThemeProps
} from "./chunk-LSA5AZVK.js";
import {
  resolveComponentProps_default
} from "./chunk-2WXROYTB.js";
import {
  refType_default
} from "./chunk-4BZQZ3KG.js";
import {
  useTimeout
...
import {
  ...
  styled_default,
  useRtl
} from "./chunk-R6KNR66Z.js";
import {
  capitalize,
  require_prop_types,
  useEnhancedEffect_default
} from "./chunk-55AXXCT7.js";
import {
  _extends
...
var PickerTextFieldOwnerStateContext = React2.createContext(null);
var usePickerTextFieldOwnerState = () => {
  const value = React2.useContext(PickerTextFieldOwnerStateContext);
  if (value == null) {
...
var PickersInputBase = React3.forwardRef(function PickersInputBase2(inProps, ref) {
  ...
  const activeBarRef = React3.useRef(null);
  const sectionOffsetsRef = React3.useRef([]);
  const handleRootRef = useForkRef(ref, rootRef);
  ...
  return (0, import_jsx_runtime2.jsxs)(InputRoot, _extends({}, inputRootProps, {
    children: [startAdornment, (0, import_jsx_runtime2.jsx)(PickersSectionList, {
      ...
      ref: handleInputRef
    })), isSingleInputRange && (0, import_jsx_runtime2.jsx)(PickersInputBaseActiveBar, {
...
function Outline(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(OutlineRoot, _extends({
    ...
    children: (0, import_jsx_runtime3.jsx)(OutlineLegend, {
      ownerState,
      notched,
      children: label ? (0, import_jsx_runtime3.jsx)(OutlineLabel, {
        children: label
      }) : (
...
var PickersOutlinedInput = React5.forwardRef(function PickersOutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(PickersInputBase, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime4.jsx)(Outline, {
      ...
      label: label != null && label !== "" && (muiFormControl == null ? void 0 : muiFormControl.required) ? (0, import_jsx_runtime4.jsxs)(React5.Fragment, {
        children: [label, " ", "*"]
      }) : label
    })
  }, other, {
...
function useFieldOwnerState(parameters) {
  ...
  const isRtl = useRtl();
  return React8.useMemo(() => _extends({}, pickerOwnerState, {
...
var PickersTextField = React9.forwardRef(function PickersTextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiPickersTextField"
  });
  ...
  const ownerState = React9.useMemo(() => _extends({}, fieldOwnerState, {
  ...
  return (0, import_jsx_runtime7.jsx)(PickerTextFieldOwnerStateContext.Provider, {
    value: ownerState,
    children: (0, import_jsx_runtime7.jsxs)(PickersTextFieldRoot, _extends({
      ...
      children: [label != null && label !== "" && (0, import_jsx_runtime7.jsx)(InputLabel_default, _extends({
        ...
        "data-active-range-position": dataActiveRangePosition
      }, inputAdditionalProps, InputProps)), helperText && (0, import_jsx_runtime7.jsx)(FormHelperText_default, _extends({
        id: helperTextId
      }, FormHelperTextProps, {
        children: helperText
      }))]
...
function useApplyDefaultValuesToTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React10.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
function useApplyDefaultValuesToDateTimeFieldInternalProps(internalProps) {
  ...
  const ampm = React11.useMemo(() => internalProps.ampm ?? utils.is12HourCycleInCurrentLocale(), [internalProps.ampm, utils]);
...
var PickerFieldUIContext = React12.createContext({
  slots: {},
  slotProps: {},
  inputRef: void 0
});
function PickerFieldUI(props) {
  ...
  const pickerFieldUIContext = React12.useContext(PickerFieldUIContext);
  const {
    textFieldProps,
    onClear,
    clearable,
  ...
  if (!((_a = textFieldProps.InputProps) == null ? void 0 : _a.startAdornment) && (clearButtonPosition === "start" || openPickerButtonPosition === "start")) {
    textFieldProps.InputProps.startAdornment = (0, import_jsx_runtime8.jsxs)(InputAdornment, _extends({}, startInputAdornmentProps, {
      children: [openPickerButtonPosition === "start" && (0, import_jsx_runtime8.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime8.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      })), clearButtonPosition === "start" && (0, import_jsx_runtime8.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime8.jsx)(ClearIcon2, _extends({}, clearIconProps))
      }))]
    }));
  }
  if (!((_b = textFieldProps.InputProps) == null ? void 0 : _b.endAdornment) && (clearButtonPosition === "end" || openPickerButtonPosition === "end")) {
    textFieldProps.InputProps.endAdornment = (0, import_jsx_runtime8.jsxs)(InputAdornment, _extends({}, endInputAdornmentProps, {
      children: [clearButtonPosition === "end" && (0, import_jsx_runtime8.jsx)(ClearButton, _extends({}, clearButtonProps, {
        children: (0, import_jsx_runtime8.jsx)(ClearIcon2, _extends({}, clearIconProps))
      })), openPickerButtonPosition === "end" && (0, import_jsx_runtime8.jsx)(OpenPickerButton, _extends({}, openPickerButtonProps, {
        children: (0, import_jsx_runtime8.jsx)(OpenPickerIcon, _extends({}, openPickerIconProps))
      }))]
    }));
  }
  ...
  return (0, import_jsx_runtime8.jsx)(TextField, _extends({}, textFieldProps));
}
...
function PickerFieldUIContextProvider(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(PickerFieldUIContext.Provider, {
    value: contextValue,
    children
  });
}
...
var useMobilePicker = (_ref) => {
  ...
  const renderPicker = () => (0, import_jsx_runtime10.jsx)(PickerProvider, _extends({}, providerProps, {
    children: (0, import_jsx_runtime10.jsxs)(PickerFieldUIContextProvider, {
      ...
      slotProps,
      inputRef,
      children: [(0, import_jsx_runtime10.jsx)(Field, _extends({}, fieldProps)), (0, import_jsx_runtime10.jsx)(PickersModalDialog, {
        slots,
        slotProps,
...
var useFieldState = (parameters) => {
  ...
  const valueRef = React15.useRef(value);
  React15.useEffect(() => {
  ...
  const getSectionsFromValue = React15.useCallback((valueToAnalyze) => fieldValueManager.getSectionsFromValue(valueToAnalyze, (date) => buildSectionsFromFormat({
    utils,
  ...
  const areAllSectionsEmpty = React15.useMemo(() => state.sections.every((section) => section.value === ""), [state.sections]);
  ...
  const sectionToUpdateOnNextInvalidDateRef = React15.useRef(null);
...
function useFieldInternalPropsWithDefaults(parameters) {
  ...
  const handleChangeFromPicker = React16.useCallback((newValue, ctx) => {
    return setValue == null ? void 0 : setValue(newValue, {
      validationError: ctx.validationError,
      shouldClose: false
    });
  }, [setValue]);
  const internalPropsWithDefaultsFromContext = React16.useMemo(() => {
...
function useFieldSectionContainerProps(parameters) {
  ...
  return React18.useCallback((sectionIndex) => ({
...
function useFieldSectionContentProps(parameters) {
  ...
  return React19.useCallback((section, sectionIndex) => {
    const sectionBoundaries = sectionsValueBoundaries[section.type]({
...
var useFieldV7TextField = (parameters) => {
  ...
  const domGetters = React20.useMemo(() => ({
...
//# sourceMappingURL=chunk-3IGLM2YG.js.map
