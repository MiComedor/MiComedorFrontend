import {
  ...
  useViews,
  validateDate
} from "./chunk-PZXNFCZN.js";
import {
  Typography_default
} from "./chunk-SMT3XUGA.js";
import {
  Fade_default
} from "./chunk-UKCZ7U6Y.js";
import {
  useSlotProps_default
} from "./chunk-BFJNUJA4.js";
import {
  IconButton_default
} from "./chunk-3F5TP7CA.js";
import {
  useThemeProps
} from "./chunk-Q7Z52CAJ.js";
import {
  ButtonBase_default
} from "./chunk-4PHTLILX.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-PWOLNSZG.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-GDGBM5H6.js";
import {
  useControlled
} from "./chunk-QSIUHCRS.js";
import {
  useId
...
import {
  ...
  useForkRef
} from "./chunk-OJ4UETAF.js";
import {
  useTheme
} from "./chunk-Y55FVTVC.js";
import {
  alpha,
  clsx_default,
  composeClasses,
  ...
  styled_default,
  useRtl
} from "./chunk-UBJF4LRK.js";
import {
  require_prop_types,
  useEnhancedEffect_default
} from "./chunk-C5T7CZTK.js";
import {
  _extends
...
var _excluded2 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var MonthCalendarButton = React3.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime2.jsx)(MonthButton, _extends({}, monthButtonProps));
});

// node_modules/@mui/x-date-pickers/esm/MonthCalendar/MonthCalendar.js
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var _excluded3 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React4.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React4.useMemo(() => utils.getMonth(now), [utils, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React4.useState(() => selectedMonth || utils.getMonth(referenceDate));
  ...
  const isMonthDisabled = React4.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime3.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(utils, value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime3.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
var _excluded4 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var YearCalendarButton = React5.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime4.jsx)(YearButton, _extends({}, yearButtonProps));
});

// node_modules/@mui/x-date-pickers/esm/YearCalendar/YearCalendar.js
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var _excluded5 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsOrder", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var YearCalendar = React6.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React6.useMemo(() => utils.getYear(now), [utils, now]);
  const selectedYear = React6.useMemo(() => {
    if (value != null) {
      return utils.getYear(value);
    }
    return null;
  }, [value, utils]);
  const [focusedYear, setFocusedYear] = React6.useState(() => selectedYear || utils.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React6.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime5.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime5.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime5.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
var _excluded7 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "classes", "timezone", "format"];
...
var useIsDateDisabled = ({
  ...
  return React9.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React10.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime8.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React11.cloneElement(element, {
...
var _excluded9 = ["parentProps", "day", "focusedDay", "selectedDays", "isDateDisabled", "currentMonthNumber", "isViewFocused"];
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React12.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const isOutsideCurrentMonth = React12.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
  ...
  const isFirstVisibleCell = React12.useMemo(() => {
  ...
  const isLastVisibleCell = React12.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React12.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React12.useMemo(() => React12.createRef(), [transitionKey]);
  const weeksToDisplay = React12.useMemo(() => {
...
var _excluded11 = ["toolbarFormat", "toolbarPlaceholder", "className", "classes"];
...
var DatePickerToolbar = React14.forwardRef(function DatePickerToolbar2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsx)(DatePickerToolbarRoot, _extends({
    ref,
    toolbarTitle: translations.datePickerToolbarTitle,
    className: clsx_default(classes.root, className)
  }, other, {
    children: (0, import_jsx_runtime11.jsx)(DatePickerToolbarTitle, {
      variant: "h4",
...
//# sourceMappingURL=chunk-EBIVP4IM.js.map
