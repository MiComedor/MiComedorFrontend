...
var useChartVoronoi = ({
  ...
  const voronoiRef = React15.useRef({});
  const delauneyRef = React15.useRef(void 0);
  const lastFind = React15.useRef(void 0);
...
var _excluded9 = ["children", "localeText", "plugins", "seriesConfig"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime13.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime13.jsx)(ChartsLocalizationProvider, {
      localeText,
      children
    })
  }));
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime16.jsx)("linearGradient", _extends({
    id: gradientId
...
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime17.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime17.jsxs)(React20.Fragment, {
          children: [(0, import_jsx_runtime17.jsx)(ChartsContinuousGradient, {
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime17.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime17.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSurface = React21.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime18.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime18.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime18.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
//# sourceMappingURL=chunk-QHC6JQPN.js.map
