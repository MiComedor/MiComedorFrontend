...
var require_use_sync_external_store_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      var React43 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore = React43.useSyncExternalStore, useRef11 = React43.useRef, useEffect12 = React43.useEffect, useMemo7 = React43.useMemo, useDebugValue = React43.useDebugValue;
...
function useColorProcessor(seriesType) {
  const store = useStore();
  const seriesConfig5 = useSelector(store, selectorChartSeriesConfig);
  const colorProcessors = React21.useMemo(() => {
    const rep = {};
...
function usePointerType() {
  ...
  const [pointerType, setPointerType] = React22.useState(null);
  React22.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function ChartsTooltipContainer(inProps) {
  ...
  const anchorEl = React24.useMemo(() => ({
  ...
  const modifiers = React24.useMemo(() => [{
    name: "offset",
    options: {
      offset: () => {
  ...
  return (0, import_jsx_runtime7.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime7.jsx)(ChartsTooltipRoot, _extends({
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React26.forwardRef(ConsumeSlotsInternal);
};
...
}, React28.forwardRef(function ChartsLegend2(props, ref) {
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime15.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime17.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime17.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var useChartVoronoi = ({
  ...
  const voronoiRef = React35.useRef({});
  const delauneyRef = React35.useRef(void 0);
  const lastFind = React35.useRef(void 0);
...
var _excluded13 = ["children", "localeText", "plugins", "seriesConfig"];
...
function ChartDataProvider(props) {
  ...
  return (0, import_jsx_runtime18.jsx)(ChartProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime18.jsx)(ChartsLocalizationProvider, {
      localeText,
      children
    })
  }));
  ...
  return (0, import_jsx_runtime19.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime19.jsxs)(React37.Fragment, {
        children: [(0, import_jsx_runtime19.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index2],
          stopOpacity: 1
        }), (0, import_jsx_runtime19.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime20.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
...
function ChartsContinuousGradientObjectBound(props) {
  ...
  const keyPrefix = `${extremumValues[0]}-${extremumValues[1]}-`;
  return (0, import_jsx_runtime21.jsx)("linearGradient", _extends({
    id: gradientId
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime21.jsx)("stop", {
        offset,
        stopColor: color2,
        stopOpacity: 1
      }, keyPrefix + index2);
    ...
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime22.jsxs)(React40.Fragment, {
          children: [(0, import_jsx_runtime22.jsx)(ChartsContinuousGradient, {
            isReversed: !reverse2,
            scale: scale2,
            colorScale,
            colorMap,
            ...
            gradientId,
            direction: "y"
          }), (0, import_jsx_runtime22.jsx)(ChartsContinuousGradientObjectBound, {
            isReversed: reverse2,
            colorScale,
            colorMap,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime22.jsx)(ChartsContinuousGradientObjectBound, {
          colorScale,
          colorMap,
          gradientId: objectBoundGradientId
...
var ChartsSurface = React41.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime23.jsxs)(ChartsSurfaceStyles, _extends({
    ownerState: {
      width: propsWidth,
      height: propsHeight
    },
    ...
    ref: handleRef,
    children: [title && (0, import_jsx_runtime23.jsx)("title", {
      children: title
    }), desc && (0, import_jsx_runtime23.jsx)("desc", {
      children: desc
    }), (0, import_jsx_runtime23.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
var _excluded15 = ["width", "height", "margin", "children", "series", "colors", "dataset", "desc", "onAxisClick", "disableVoronoi", "voronoiMaxRadius", "onItemClick", "disableAxisListener", "highlightedItem", "onHighlightChange", "sx", "title", "xAxis", "yAxis", "zAxis", "rotationAxis", "radiusAxis", "skipAnimation", "seriesConfig", "plugins", "localeText"];
...
function ChartsWrapper(props) {
  ...
  return (0, import_jsx_runtime24.jsx)(Root3, {
    ref: chartRootRef,
    ownerState: props,
    sx,
    children
...
use-sync-external-store/cjs/use-sync-external-store-with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-S7CL74LG.js.map
